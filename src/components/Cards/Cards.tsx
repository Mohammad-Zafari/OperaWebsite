...
const cardData = [
  ...
  },
  {
    ...
    description:
      "با کمک اپرا می‌توانید تمامی تماس هاس ورودی و خروجی را بازرسی کنید .این امر موجب میشود که...",
  ...
  },
  {
    ...
    description: "با استفاده از خدمات اپرا می‌توانید در هزینه های خود صرفه جویی کنید .",
  ...
  },
  {
    ...
    description: "با تهیه محصولات اپرا میتوانید از پشتیبانی دائمی آن نیز برخوردار شوید!",
