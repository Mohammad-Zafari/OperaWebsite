    ...
    return (
        ...
        <div className='w-11/12 sm:w-8/12 lg:w-6/12 xl:w-4/12 bg-gray-100 rounded-2xl shadow-lg py-8 mx-auto mt-40'>
            ...
            <div className='p-8 sm:p-16' style={{direction:"rtl"}}>
                ...
                onChange={(e) => dispatch(RsetEmail(e.target.value))} type='email'
                />
                <Button className='px-8 py-5 mr-1 text-white text-lg bg-violet-600 hover:text-violet-600 hover:bg-white'>ارسال</Button>
            </div>
        </div>
        </>
  )
