...
import ConfirmPassword from "../forgetPass/ConfirmPassword "; // Import the ConfirmPassword component
...
const ForgetPass = () => {
  ...
  const handleForgetPass = () => {
    setShowConfirmPassword(true); // Show ConfirmPassword component on button click
  };
