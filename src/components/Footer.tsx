    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex flex-1 text-[#979595] lg:justify-end">
            <div className="text-sm flex flex-row-reverse flex-wrap gap-2">
              <p>:تلفن تماس</p>
            ...
            <img
              className="xl:size-6 md:size-4 size-2 ml-2"
              src="phone icon.svg"
              alt=""
            />
          </div>
      ...
      <div id="bottom" className="flex-1 flex text-xs items-center">
        <p>
          ...
          <span className="text-[#8E5CC2]"> اپرا</span> محفوظ است
        </p>
        <img
          src="/Group 2483.svg"
          alt=""
