...
const ServicesCards = () => {
  ...
  return (
    <>
        <div className='bg-purple-600 py-20 xl:px-12 2xl:px-48' style={{direction:"rtl"}}>
          <h1 className='text-2xl w-fit text-white border-b-2 pb-2 mr-20'>طرح ها</h1>
          <div className='md:flex justify-center py-24'>
