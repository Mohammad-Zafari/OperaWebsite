        ...
        >
          ...
          <div id="buttonContainer" className="flex justify-end ml-8 py-12">
            <a
              ...
              href="#"
              className="flex items-end p-4 rounded-xl bg-gradient-to-l duration-1000 from-[#ddc157] to-[#78682f] text-black text-lg hover:bg-gradient-to-l hover:from-[#a07f3b] hover:to-[#a07f3b] "
            >
              مشاهده محصولات
